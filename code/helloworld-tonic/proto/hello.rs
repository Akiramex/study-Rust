...
pub mod hello_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn vote(
            ...
            let path = http::uri::PathAndQuery::from_static("/hello.Hello/Vote");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("hello.Hello", "Vote"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/hello.Hello/Vote" => {
                    ...
                    struct VoteSvc<T: Hello>(pub Arc<T>);
                    ...
                    for VoteSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Hello>::vote(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
