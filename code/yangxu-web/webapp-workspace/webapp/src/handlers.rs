use crate::wa::models::{TeacherRegisterForm, TeacherReponse};
...
pub async fn show_register_teachers(tmpl: web::Data<tera::Tera>) 
-> Result<HttpResponse, Error> {
    let mut ctx = tera::Context::new();
    ctx.insert("error", "");
...
pub async fn handle_register(
    ...
    if params.name == "Dave" {
        ...
        let teacher_response: TeacherReponse = serde_json::from_str(&std::str::from_utf8(&res)?)?;
